...
@onready var TURRETS = {
	...
	"egg_prod" = Turret_Data.new("Egg Producer", 1, "Dokium is eggs", 
		...
		0, 1),
	"indoc_prod" = Turret_Data.new("Dokium Injection", 5, "Doki streams are good for the soul", 
		load("res://assets/dragoons/drgn-indo/01.png"), "res://scenes/dragoons/dokiumProd/indoctrinationProd/indoctrination_prod.tscn",
		0, 2),
	"appraisal_prod" = Turret_Data.new("Appraise Dokibird", 10, "Appraise Doki for her streamer build", 
	...
	"airforce_goon" = Turret_Data.new("Airforce-goon", 30, "Airforce Dragoon", 
